...
#Preview(traits: .sizeThatFitsLayout) {
    CodeRowView(code: USSDCode(
        id: "sms-bundle-20",
        code: "*133*2*1#",
        title: LocalizedText(es: "Plan de 20 SMS", en: "20 SMS Plan"),
        details: LocalizedText(es: "20 SMS.", en: "20 SMS."),
        icon: nil,
        price: "$15.00",
        compact: nil,
        showsNumber: nil,
...
#Preview(traits: .sizeThatFitsLayout) {
    ContactRowView(
        code: USSDCode(
            id: "emergency-police",
            code: "106",
            title: LocalizedText(es: "Policía Nacional (PNR)", en: "National Police (PNR)"),
            details: LocalizedText(es: "Policía Nacional Revolucionaria.", en: "Revolutionary National Police."),
            icon: "shield.fill",
            price: nil,
            compact: nil,
            showsNumber: true,
